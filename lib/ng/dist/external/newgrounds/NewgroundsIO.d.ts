...
export class NGIO {
    ...
    static "__#2@#lastConnectionStatus": Date;
    /**
    ...
    static "__#2@#lastMedalUnlocked": boolean;
    /**
    ...
    static "__#2@#lastBoardPosted": boolean;
    /**
    ...
    static "__#2@#lastScorePosted": boolean;
    /**
    ...
    static "__#2@#lastGetScoresResult": boolean;
    /**
    ...
    static "__#2@#version": string;
    /**
     * Will be tue if using debugMode via Init()
     * @type {boolean}
     */
    static get debugMode(): boolean;
    static "__#2@#debugMode": boolean;
    static "__#2@#preloadFlags": {
        autoLogNewView: boolean;
        preloadMedals: boolean;
        preloadScoreBoards: boolean;
        preloadSaveSlots: boolean;
    };
    static "__#2@#sessionReady": boolean;
    static "__#2@#skipLogin": boolean;
    static "__#2@#localVersionChecked": boolean;
    static "__#2@#checkingConnectionStatus": boolean;
    /**
     ...
     */
    static unlockMedal(medalID: number, callback?: (medal: NewgroundsIO.objects.Medal) => any, thisArg?: object): void;
    /**
     ...
     * @param {object} [thisArg] An optional object to use as 'this' in your callback function.
     */
    static postScore(boardID: number, value: number, tag?: string, callback?: (scoreBoard: NewgroundsIO.objects.ScoreBoard, score: NewgroundsIO.objects.Score) => any, thisArg?: object): void;
    /**
    ...
    }, callback?: (scoreBoard: NewgroundsIO.objects.ScoreBoard, score: NewgroundsIO.objects.Score, options: {
        period: string;
        tag: string;
        social: boolean;
        skip: number;
        limit: number;
    }) => any, thisArg?: object): void;
    /**
     ...
     * @param {object} [thisArg] An optional object to use as 'this' in your callback function.
     */
    static getSaveSlotData(slotID: number, callback?: (data: string) => any, thisArg?: object): void;
    /**
     ...
     * @param {object} [thisArg] An optional object to use as 'this' in your callback function.
     */
    static setSaveSlotData(slotID: number, data: string, callback?: (saveSlot: NewgroundsIO.objects.SaveSlot) => any, thisArg?: object): void;
    /**
     ...
     * @param {object} [thisArg] An optional object to use as 'this' in your callback function.
     */
    static logEvent(eventName: string, callback?: (eventName: string) => any, thisArg?: object): void;
    /**
     ...
     * @param {object} [thisArg] An optional object to use as 'this' in your callback function.
     */
    static getDateTime(callback?: (dateime: string, timestamp: number) => any, thisArg?: object): void;
    /**
     ...
     * @param {object} [thisArg] An optional object to use as 'this' in your callback function.
     */
    static getConnectionStatus(callback?: (connectionStatus: string) => any, thisArg?: object): void;
    static "__#2@#updateSessionHandler"(callback: any, thisArg: any): void;
    static "__#2@#reportConnectionStatus"(callback: any, thisArg: any): void;
    static "__#2@#checkLocalVersion"(callback: any, thisArg: any): void;
    static "__#2@#PreloadItems"(): void;
    static "__#2@#resetConnectionStatus"(): void;
    static "__#2@#replaceSaveSlot"(slot: any): void;
    static "__#2@#replaceScoreBoard"(board: any): void;
    static "__#2@#replaceMedal"(medal: any): void;
    static "__#2@#onServerResponse"(e: any): void;
    static "__#2@#handleNewComponentResult"(result: any): void;
}
/**
 * NewgroundsIO Namespace
 * @namespace
 */
declare var NewgroundsIO: any;
export {};
